...
public class Experience extends Employee{
    ...
    public String toString() {
        return "information of experience[ "+ " ID: "+ ID + ", Fullname: " + fullname + ", Birth day: " +  birthDay + ", Phone: " + phone + ", Email: " + email + ", Certificates: " + certificates.toString() +  ", Experience in year: " + experienceInYear + ", Pro skill: " + proSkill + " ]";
    }
}
